...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config=None, **kwargs):
        ...
        self.ocr_gather_head = SpatialGather_Module(self.num_class)
        ...
        self.cls_head = nn.Conv2d(
            ocr_mid_channels, self.num_class, kernel_size=1, stride=1, padding=0, bias=True)
        ...
        self.aux_head = nn.Sequential(
            ...
            nn.ReLU(inplace=relu_inplace),
            nn.Conv2d(last_inp_channels, self.num_class,
    ...
    def _make_stage(self, layer_no, num_inchannels,
        ...
        num_channels = [[48], [48, 96], [48, 96, 192], [48, 96, 192, 384]]
